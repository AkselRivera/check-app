...
import { deleteFamily } from "../../../api/family/deleteFamily";
import { cleanFamily } from "../../../reducer/ui";
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-evenly h-96 text-center  group">
          ...
          <div className="flex max-h-4/5 items-center justify-center">
            <ul className="text-left list-disc">
              <li>
                <label className="font-semibold">Products count:</label>
                <span className="ml-2 group-hover:text-red-600 ease-in-out duration-300">
                  {selectedFamily?.productsCount}
                </span>
              </li>
              ...
              <li>
                ...
                <span className="ml-2 group-hover:text-red-600 ease-in-out duration-300">
                  ${selectedFamily?.total.toFixed(2)}
                </span>
              </li>
            </ul>
          </div>
